...
class Che_Techtalk_Block_Adminhtml_Contact_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
   {
    ...
    public function getHeaderText()
    {
        if (Mage::registry('contact_request')->getId()) {
            return Mage::helper('techtalk')->
            __("Edit Request # %s", $this->escapeHtml(Mage::registry('contact_request')->getId()));
        }
        else {
